...
const TechStack = () => {
  return (
    <div className="mx-auto text-gray-300 mt-16 my-10">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-2 gap-y-4  gap-2 items-center  my-6 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[55%] mx-auto">
        <p className="col-span-1">Laguages:</p>
        <div className="col-span-2 sm:col-span-1 flex gap-4 h-10">
        ...
        <div className="col-span-2 sm:col-span-1 flex items-center gap-4 h-10">
